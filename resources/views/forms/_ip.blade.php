...
<div class="form-fields flex flex_left">
    ...
    <x-input-wrap name="inn"></x-input-wrap>
    <x-input-wrap name="snils"></x-input-wrap>
    <x-input-wrap name="ogrnip_ser" required="true"></x-input-wrap>
    <x-input-wrap name="ogrnip_num" required="true"></x-input-wrap>
    <x-input-wrap name="ogrnip_date" required="true" mask="mask-date"></x-input-wrap>
...
<div class="form__files">
    ...
    <x-input-file-wrap name="doc_ogrnip" required="true"></x-input-file-wrap>
</div>
@if(!Auth::check())
<div class="center">
